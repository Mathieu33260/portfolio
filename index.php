			...
			<div class="row">
				...
				<div class="col-sm-8">
					...
					<div class="experience margin-b-50">
						...
						<ul class="list margin-b-30">
							<li>BACKEND, FRONTEND, MOBILE & API</li>
							<li>Autonomie, conception, interaction client et innovation.</li>
						</ul>
					</div>
					...
					<div class="experience margin-b-50">
						...
						<ul class="list margin-b-30">
							...
							<li>Gestion d'équipe et collaboration avec des partenaires</li>
							<li>BACKEND, FRONTEND, MOBILE & API</li>
						</ul>
					</div><!-- experience -->
					...
					<div class="experience margin-b-50">
						...
						<p class="font-semi-white margin-tb-30">Réalisation d'une API Web en collaboration avec des chercheurs
							et des étudiants issus de différents à l'université de Glyndwr au Pays de Galles, dans le cadre
							d'un stage de fin d'études. </p>
						<ul class="list margin-b-30">
							<li>API & BACKEND</li>
							<li>Immersion totale dans un pays anglophone</li>
				...
				<div class="col-sm-8">
					<div class="education-wrapper">
						<div class="education margin-b-50">
							<h4><b>MASTER WEB</b></h4>
							<h5 class="font-yellow"><b>ECV DIGITAL BORDEAUX</b></h5>
							<h6 class="font-lite-black margin-t-10">DIPLÔMÉ EN 2020 (2 ANS)</h6>
						</div><!-- education -->

						<div class="education margin-b-50">
							<h4><b>LICENCE PRO DAWIN</b></h4>
						...
						<div class="education margin-b-50">
							...
							<h6 class="font-lite-black margin-t-10">DIPLÔMÉ EN 2015 (3 ANS)</h6>
						</div><!-- education -->
